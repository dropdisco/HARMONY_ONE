...
export function handleNewPair(event: PairCreated): void {
  ...
  if (factory === null) {
    ...
    factory.totalVolumeUST = ZERO_BD
    factory.untrackedVolumeUST = ZERO_BD
    factory.totalLiquidityUST = ZERO_BD
  ...
  if (token0 === null) {
    ...
    token0.tradeVolumeUST = ZERO_BD
    token0.untrackedVolumeUST = ZERO_BD
  ...
  if (token1 === null) {
    ...
    token1.tradeVolumeUST = ZERO_BD
    token1.untrackedVolumeUST = ZERO_BD
  ...
  pair.reserveUST = ZERO_BD
  pair.totalSupply = ZERO_BD
  pair.volumeToken0 = ZERO_BD
  pair.volumeToken1 = ZERO_BD
  pair.volumeUST = ZERO_BD
  pair.untrackedVolumeUST = ZERO_BD
